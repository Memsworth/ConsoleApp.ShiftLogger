...
namespace ShiftLoggerApi.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EmployeeId,Name,DateOfBirth,Email")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmployeeId,Name,DateOfBirth,Email")] Employee employee)
        {
